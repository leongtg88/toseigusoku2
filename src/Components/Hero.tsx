...
const Hero = () => {
  return (
    ...
    {/* Contenedor principal del hero */}
      ...
      sm:px-6
      lg:px-2 lg:py-[80px]  lg:flex-row lg:itmes-start 
      xl:items-center  
      2xl:pb-[180px]   ">

            {/*Conteneodr izquierdo imagenes */}

            <div className='relative px-8 pt-[40px]  h-[400px] lg:w-1/2 lg:h-[460px]  2xl:h-[600px] flex justify-center lg:justify-start'>

              {/*Contenedor inquierdo hijo imagenes */}
              <div className="relative h-full lg:h-full lg:w-full xl:h-[300px]  flex flex-col  items-center">

                  {/* Blur effect  */}
                  <div className="absolute w-full sm:w-[500px] bottom-[-60px]
                ...
                <img
                  ...
                  className="absolute w-[100%] max-w-[360px] h-[280px] -top-[60px] -translate-x-[80px]
                    sm:w-[100%] sm:max-w-[360px] sm:h-[280px] sm:top-[20px]  sm:-translate-x-[90px] sm:-translate-y-[125px]
                    lg:w-[100%] lg:max-w-[500px] lg:h-[500px] lg:top-1/2 lg:-lelg:transform  lg:-translate-y-[275px]"
                />
                <img
                  src={kyoshi}
                  alt="Kyoshi"
                  className="absolute w-[100%] max-w-[220px] h-[220px] -top-[70px] translate-x-[50px]
                    sm:w-[100%] sm:max-w-[280px] sm:h-[250px] sm:top-[0px] sm:translate-x-[60px] sm:-translate-y-[125px]
                ...
                <img
                  ...
                  className="absolute w-[200px] h-[200px] top-[20px] translate-x-[-20px]
                    ...
                    lg:w-[100%] lg:max-w-[400px] lg:h-[400px] lg:top-1/2 lg:left-1/2 lg:transform lg:-translate-x-45 lg:-translate-y-[150px]"
                />
                <img
                  src={rika}
                  alt="Rika"
                  className="absolute w-[220px] h-[220px] top-[60px] -translate-x-[110px]
                    ...
                    lg:w-[100%] lg:max-w-[400px] lg:h-[400px] lg:top-1/2 lg:left-1/2 lg:transform lg:-translate-x-78 lg:-translate-y-1/3"
                />
                <img
                  src={imageLeon}
                  alt="Leon"
                  className="absolute w-[85%] max-w-[250px] h-[250px] top-[40px] translate-x-[60px]
                    sm:w-[80%] sm:max-w-[280px] sm:h-[240px] sm:top-[100px] sm:translate-x-[80px] sm:-translate-y-[70px]
                    lg:w-[100%] lg:max-w-[400px] lg:h-[380px] lg:top-1/2 lg:left-1/2 lg:transform lg:-translate-x-13 lg:-translate-y-[113px]"
                />
                <img
                  src={german}
                  alt="German"
                  className="absolute w-[180px] h-[180px] top-[100px] translate-x-[-30px]
                    sm:w-[60%] sm:max-w-[200px] sm:h-[200px] sm:top-[50px] sm:-translate-x-[15px] sm:translate-y-[15px]
                ...
                bottom-[60px] ml-8 h-[30px]  w-[350px] max-w-[450px]
                sm:bottom-[80px] sm:ml-8 sm:h-[30px] sm:w-[450px] sm:max-w-[450px]
                lg:bottom-[-125px] lg:left-1/2 lg:transform 
                lg:-translate-y-[33px]  lg:h-[60px] lg:w-[500px] 
                xl:bottom-[-185px] xl:left-1/2 xl:transform xl:-translate-x-1/2 xl:w-[500px]"
                  style={{
                    animation: "color-change 10s infinite linear",
