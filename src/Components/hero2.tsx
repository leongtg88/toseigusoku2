...
const Hero2 = () => {
  return (
    <div
      className="relative h-screen lg:h-[1300px] w-full bg-no-repeat bg-cover bg-center bg-fixed "
      style={{ backgroundImage: `url(${heroImageDesktop})` }}
    >
      <div className="absolute inset-0 bg-black/60" />

      <div className="relative h-full grid grid-cols-1 lg:grid-cols-1 items-center px-4 sm:px-6 lg:px-2">
        ...
        <div className="text-left text-white max-w-lg mx-auto">
...
export default Hero2;
                        ...
                        <div
                            id="container__blur2"
                            className="absolute bottom-0 h-12 rounded-l rounded-r
                            md:bottom-[-44px] md:left-1/2 md:transform md:-translate-x-40 md:-translate-y-[33px]       
                            md:w-[350px] bg-gradient-to-t from-[#bfe4fd] via-[#9cd3f8a1] to-transparent
                            lg:bottom-[-27px] lg:left-1/2 lg:transform lg:-translate-x-40 lg:-translate-y-[33px]       
                            lg:w-[450px] bg-gradient-to-t from-[#bfe4fd] via-[#9cd3f8a1] to-transparent "
                        ></div>